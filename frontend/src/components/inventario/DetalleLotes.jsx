    ...
    <div style={overlay} data-modal="">
        ...
        {mostrarForm ? (
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 16 }}>
                ...
                <button onClick={crearLote} disabled={guardando} style={{ ...btnBase, background: "#2563eb", color: "#fff" }}>
                {guardando ? "Guardando..." : "Guardar lote"}
                </button>
            </div>
            </div>
        ) : (
            <button onClick={() => setMostrarForm(true)} style={{ ...btnBase, background: "#2563eb", color: "#fff", width: "100%" }}>
